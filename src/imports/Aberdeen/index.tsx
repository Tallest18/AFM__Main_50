...
function Frame16() {
  return (
    <div className="overflow-clip relative shrink-0 size-[120px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.5px)] size-[137px] top-[calc(50%+0.5px)]" data-name="Aberdeen transparent background 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAberdeenTransparentBackground1} />
      </div>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 whitespace-nowrap">
      ...
      <div className="capitalize flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[#38362d] text-[64px]">
        <p className="leading-[normal]">ABERDEEN</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute h-[579px] left-0 overflow-clip top-[371px] w-[1442px]">
      <div className="-translate-y-1/2 absolute h-[1211px] left-0 top-1/2 w-[1500px]" data-name="3160 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img31601} />
      </div>
    </div>
  );
}
