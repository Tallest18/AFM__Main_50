import svgPaths from "./svg-1g1syqvfwl";
import imgImage from "./9ec56a815db13e6f5f4c4f51dc8c89bded734cf2.png";
import imgBirminghamTransparentBackground1 from "./f1d48fef0e75967a097f7fd20e90f8e8f4f0e351.png";
import img20681 from "./5bb903ae1dd174a13b92b38ae5d82a46f0d9366a.png";
...
function Frame16() {
  return (
    <div className="overflow-clip relative shrink-0 size-[120px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.11px)] size-[135px] top-[calc(50%+0.11px)]" data-name="Birmingham transparent background 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgBirminghamTransparentBackground1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 whitespace-nowrap">
      ...
      <div className="flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[#38362d] text-[64px]">
        <p className="leading-[normal]">BIRMINGHAM</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 text-[#38362d] text-[24px] whitespace-nowrap">
      ...
      <div className="flex flex-col font-['Futura_PT:Book',sans-serif] justify-center relative shrink-0">
        <p className="leading-[normal]">Birmingham, West Midlands — home of the David Academy</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute h-[579px] left-0 overflow-clip top-[371px] w-[1442px]">
      <div className="absolute h-[2161px] left-0 top-[-1292px] w-[1442px]" data-name="2068 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img20681} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[32px] items-start leading-[0] not-italic relative shrink-0 text-[#38362d] w-[770px]">
      <div className="flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[48px] w-full">
        <p className="leading-[normal]">Home to the David Academy</p>
      </div>
      <div className="flex flex-col font-['Futura_PT:Book',sans-serif] justify-center relative shrink-0 text-[24px] w-full">
        <p className="leading-[normal]">Birmingham's story began in September 2002 with a small Bible study led by Sister Eunice Bolade. God provided a permanent home in 2010, dedicated the following February. Today it is the largest AFC facility in Western Europe, averaging around 110 worshippers weekly under Bro Lazarus Simbanegavi. In April 2026, the church launched the David Academy, a music education initiative for ages four to forty, led by Principal Bro Ebenezer Amusa.</p>
      </div>
    </div>
  );
}
...
export default function Birmingham() {
  return (
    <div className="bg-[#f4f1ea] relative size-full" data-name="BIRMINGHAM">
