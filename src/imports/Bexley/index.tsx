import svgPaths from "./svg-x1da9tjivc";
import imgImage from "./9ec56a815db13e6f5f4c4f51dc8c89bded734cf2.png";
import img112 from "./921466338e991e46d683df06a264fb1e3130c2a2.png";
import img93091 from "./2e6a50dd513ea62dc652a07d7c17c12556ef6faf.png";
...
function Frame16() {
  return (
    <div className="overflow-clip relative shrink-0 size-[120px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.11px)] size-[198.38px] top-[calc(50%+0.11px)]" data-name="11 2">
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 whitespace-nowrap">
      ...
      <div className="flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[#38362d] text-[64px]">
        <p className="leading-[normal]">BEXLEY</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute h-[579px] left-0 overflow-clip top-[371px] w-[1442px]">
      <div className="absolute h-[2154px] left-0 top-[-963px] w-[1442px]" data-name="9309 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img93091} />
      </div>
    </div>
  );
}
...
export default function Bexley() {
  return (
    <div className="bg-[#f4f1ea] relative size-full" data-name="BEXLEY">
