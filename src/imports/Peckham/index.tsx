import svgPaths from "./svg-09cz3yhjjn";
import imgImage from "./9ec56a815db13e6f5f4c4f51dc8c89bded734cf2.png";
import img122 from "./0cce19fd4acc08db680fdccec6c96c1b9ad2b1e8.png";
import img90991 from "./da3529783d02f20216c63bb9f6bf68b91cb518b5.png";
...
function Frame16() {
  return (
    <div className="overflow-clip relative shrink-0 size-[120px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.11px)] size-[203.028px] top-[calc(50%+0.11px)]" data-name="12 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img122} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 whitespace-nowrap">
      ...
      <div className="flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[#38362d] text-[64px]">
        <p className="leading-[normal]">PECKHAM</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute h-[579px] left-0 overflow-clip top-[371px] w-[1442px]">
      <div className="absolute h-[2163px] left-0 top-[-1082px] w-[1442px]" data-name="9099 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img90991} />
      </div>
    </div>
  );
}
...
export default function Peckham() {
  return (
    <div className="bg-[#f4f1ea] relative size-full" data-name="PECKHAM">
