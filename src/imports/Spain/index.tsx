...
const BRANCH_ADDRESS = "House fellowship, Murcia";
        ...
        <div className="flex min-w-0 flex-col items-center justify-center md:flex-row md:justify-start">
          <div className="min-w-0 text-center md:text-left">
            ...
            <h1 className="mt-2 text-[56px] leading-[0.86] tracking-[-0.035em] text-[#38362d] sm:text-[64px] md:text-[clamp(42px,6vw,72px)]">
              <span className="md:hidden">Spain</span>
              <span className="hidden md:inline">Spain</span>
            </h1>
          </div>
        </div>
      ...
      <div className="relative mx-auto grid max-w-[1240px] gap-10 md:grid-cols-[190px_minmax(0,1fr)] md:gap-10 lg:grid-cols-[210px_minmax(0,1fr)] lg:gap-12">
        ...
        <article className="order-1 md:order-2">
          ...
          <div className="mt-8 space-y-7 text-[17px] leading-[1.55] text-[#38362d] sm:text-[18px] sm:leading-[1.6]">
            ...
            <p>
              Brother Yaya Bobo has coordinated the group continuously since its founding, close to twenty years of unbroken, largely unseen leadership. As Regional Director Brother Francis Odudu puts it, the congregation is "few but zealous for the Lord." Their request to the wider Apostolic Faith family is simple and unadorned: prayer, and hope for a season of revival such as the one recently seen in Italy.
            </p>
          </div>
        </article>
      </div>
          ...
          {GALLERY_IMAGES.map((src, index) => (
            ...
            >
              <div className="aspect-[0.9/1] w-full overflow-hidden sm:aspect-[1.28/1]">
                <img
                  src={src}
                  alt={`Spain branch gathering ${index + 1}`}
                  className="block"
