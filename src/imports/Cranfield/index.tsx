import svgPaths from "./svg-bcwpkm4jot";
import imgImage from "./9ec56a815db13e6f5f4c4f51dc8c89bded734cf2.png";
import imgCranfieldTransparentBackground1 from "./c8c2c0738e82e3c7b2cf92b3def3247dacdf1cc8.png";
import img2211 from "./d014163419a822d694271a3dc47735ab42444709.png";
...
function Frame16() {
  return (
    <div className="overflow-clip relative shrink-0 size-[120px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.5px)] size-[137px] top-[calc(50%+0.5px)]" data-name="Cranfield transparent background 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCranfieldTransparentBackground1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 whitespace-nowrap">
      ...
      <div className="flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[#38362d] text-[64px]">
        <p className="leading-[normal]">CRANFIELD</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-start justify-center leading-[0] not-italic relative shrink-0 text-[#38362d] text-[24px] whitespace-nowrap">
      ...
      <div className="flex flex-col font-['Futura_PT:Book',sans-serif] justify-center relative shrink-0">
        <p className="leading-[normal]">A former Wesleyan chapel, Cranfield, Bedfordshire</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute h-[579px] left-0 overflow-clip top-[371px] w-[1442px]">
      <div className="absolute h-[1000px] left-0 top-[-339px] w-[1500px]" data-name="221 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img2211} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[32px] items-start leading-[0] not-italic relative shrink-0 text-[#38362d] w-[770px]">
      <div className="flex flex-col font-['CRONDE:Regular',sans-serif] justify-center relative shrink-0 text-[48px] w-full">
        <p className="leading-[normal]">The Newest Church</p>
      </div>
      <div className="flex flex-col font-['Futura_PT:Book',sans-serif] justify-center relative shrink-0 text-[24px] w-full">
        <p className="leading-[normal]">As Peckham families settled across Buckinghamshire, Bedfordshire, and Hertfordshire, Rev Fungai Mangere launched a weekly online Bible study in February 2022. A Wesleyan chapel came onto the market soon after, and on 15 October 2023 the new church was dedicated before leaders from as far as St Louis and Atlanta. Membership has since more than doubled, from twenty-two at dedication to forty-five each Sunday.</p>
      </div>
    </div>
  );
}
...
export default function Cranfield() {
  return (
    <div className="bg-[#f4f1ea] relative size-full" data-name="CRANFIELD">
